...
def chart():
    ...
    p1 = figure(plot_width = 600, plot_height = 600, title = 'Virtual and non-virtual',
                x_axis_label = 'virtual/non-virtual', y_axis_label = 'number of users', tooltips = TOOLTIPS)
    
    p1.vbar(x= [1,2], top = [virtual, non_virtual], width = 0.9, fill_color = "#6599ed")
    
    p2 = figure(x_range = stamp_dates, plot_width = 600, plot_height = 600, title = "Last updated stamps",
                x_axis_label = 'timestamps', y_axis_label = 'users', tooltips = TOOLTIPS)
    
    p2.vbar(x = stamp_dates, top = stamp_users, width =0.9, fill_color = "#6599ed")
